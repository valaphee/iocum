...
pub async fn get_blocked_servers(
    configuration: &configuration::Configuration,
) -> Result<String, Error<GetBlockedServersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockedServersError> =
...
pub async fn get_user_by_id(
...
) -> Result<crate::models::User, Error<GetUserByIdError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = unsigned {
        local_var_req_builder =
            local_var_req_builder.query(&[("unsigned", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn has_joined_server(
    ...
    server_id: &str,
    ip: Option<&str>,
) -> Result<crate::models::User, Error<HasJoinedServerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<HasJoinedServerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn join_server(
    configuration: &configuration::Configuration,
    join_server_request: Option<crate::models::JoinServerRequest>,
) -> Result<(), Error<JoinServerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<JoinServerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
